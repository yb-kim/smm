...
entry:
  ...
  %call = call i32 @strcmp(i8* %arraydecay, i8* %arraydecay2) #14
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([27 x i8]* @.str1, i32 0, i32 0))
  call void @exit(i32 -1) #12
  unreachable
...
if.else:                                          ; preds = %entry
  ...
  %call1 = call %struct._IO_FILE* @fopen(i8* %3, i8* getelementptr inbounds ([2 x i8]* @.str12, i32 0, i32 0))
...
while.cond:                                       ; preds = %while.body, %if.else
  ...
  %call3 = call i32 (%struct._IO_FILE*, i8*, ...)* @fscanf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([3 x i8]* @.str2, i32 0, i32 0), [128 x i8]* %qstring)
...
if.end:                                           ; preds = %while.end
  ...
  %call6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([24 x i8]* @.str33, i32 0, i32 0), i32 %9)
  ...
  call void @qsort(i8* %10, i64 %conv, i64 128, i32 (i8*, i8*)* @_Z7comparePKvS0_)
  store i32 0, i32* %i, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call12 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0), i8* %arraydecay11)
  br label %for.inc
...
entry:
  ...
  %call3 = call i32 @_Z6c_mainiPPc(i32 %2, i8** %3)
  ret i32 %call3
}
