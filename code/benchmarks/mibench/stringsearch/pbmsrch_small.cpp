...
int main()
{
	...
	c_init_map(11,
			"bmha_init", (char *)bmha_init, (char *)&spm_code, 0x1d0, r,
			"bmha_search", (char *)bmha_search, (char *)&spm_code, 0x180, r,
			"bmhi_init", (char *)bmhi_init, (char *)&spm_code, 0x2a0, r,
			"bhmi_cleanup", (char *)bhmi_cleanup, (char *)&spm_code, 0x30, r,
			"bmhi_search", (char *)bmhi_search, (char *)&spm_code, 0x190, r,
			"bmh_init", (char *)bmh_init, (char *)&spm_code, 0x160, r,
			"bmh_search", (char *)bmh_search, (char *)&spm_code, 0x170, r,
			"init_search", (char *)init_search, (char *)&spm_code, 0xd0, r,
			"strsearch", (char *)strsearch, (char *)&spm_code, 0x150, r,
			"c_main", (char *)c_main, (char *)&spm_code, 0x250, r,
			"main", (char *)main, NULL, 0x0, NULL
		  );
